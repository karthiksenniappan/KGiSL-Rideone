    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $tariff->id],array('class' => 'btn btn-info1')) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $tariff->id],array('class' => 'btn btn-dark1')) ?>
                    <!--<?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $tariff->id],array('class' => 'btn btn-danger1'), ['confirm' => __('Are you sure you want to delete # {0}?', $tariff->id)]) ?>
                    -->
                </td>
            </tr>
            <?php endforeach; ?>
