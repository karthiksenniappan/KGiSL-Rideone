...
<nav class="large-3 medium-4 columns" id="sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Employee'), ['action' => 'eedit', $emp->id],array('class' => 'btn-link')) ?> </li>
        <li><?= $this->Html->link(__('List Employee'), ['action' => 'eindex'],array('class' => 'btn-link')) ?> </li>
        <li><?= $this->Html->link(__('New Employee'), ['action' => 'eadd'],array('class' => 'btn-link')) ?> </li>
    </ul>
</nav>
