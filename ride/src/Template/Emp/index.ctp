...
<nav class="large-3 medium-4 columns" id="sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('New Emp'), ['action' => 'add'],array('class' => 'btn-link')) ?></li>
    </ul>
</nav>
    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= h($emp->salary) ?></td>
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $emp->id],array('class' => 'btn btn-info1')) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $emp->id],array('class' => 'btn btn-dark1')) ?>
